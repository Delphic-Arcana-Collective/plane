...
export const IssuesHeader = observer(function IssuesHeader() {
  ...
  // store hooks
  const {
    issues: { getGroupIssueCount, isProjectViewReady, loadedProjectId },
  ...
  const linearReady =
    ...
    (!!routeProjectId &&
      ...
      loadedProjectId === routeProjectId);

  const issuesCount = linearReady ? getGroupIssueCount(undefined, undefined, false) : undefined;
  // i18n
