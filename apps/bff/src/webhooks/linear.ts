...
import { isKvCacheBackend } from "../cache/backend.js";
...
async function waitForWebhookSync(env: Env, cache: CacheBackend, attempt = 0): Promise<void> {
  if (attempt >= 20) {
...
export async function handleLinearWebhook(
  ...
  if (deliveryId && isKvCacheBackend(cache)) {
